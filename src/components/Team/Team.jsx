...
export default function Team() {
    ...
    const team = [
        {
            avatar: "https://cdn.discordapp.com/attachments/1164514364196409377/1171859353356222607/353801131_1349401832458153_3497382202558218091_n.png?ex=669c9851&is=669b46d1&hm=3f11d619c410746c0d89effbc80e1da7a816fe1d34a89810588014f0a37df966&",
            name: "Chirag Arora",
            title: "Rev Engineer",
            desc: "Murphy's Law: Anything that can go wrong will go wrong.",
    ...
    return (
        <section className="py-14">
            <div className="max-w-screen-xl mx-auto px-4 text-center md:px-8">
                <div className="max-w-xl mx-auto pb-4 border-b-2">
                    <h3 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                        Meet our team
                    </h3>
                    <p className="text-gray-600 mt-3">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptate sed perspiciatis soluta eum vitae alias, architecto et recusandae cupiditate qui?
                    </p>
                </div>
                <div className="mt-12">
